...
const Contact = () => (
    <div className="view" align="center">
        <i className="material-icons" style={{fontSize: 100}}>place</i><br/>
        <h3>
            E-39 Karni Nagar, Gandhi Path,<br/>
            Near Bhaskar Vidhya Ashram,<br/>
            Gandhi Path, Vaishali Nagar,<br/>
            Jaipur, Rajasthan (India)<br/>
            <i className="material-icons">call</i>
            <span className="mobile-number">{ProfileData.telephone}</span><br/>
        </h3>
