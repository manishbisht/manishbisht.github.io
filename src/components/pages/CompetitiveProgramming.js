...
const CompetitiveProgramming = () => {
    const getFeaturedCompetitiveProgrammingData = () => {
        return CompetitiveProgrammingData.slice(0, 1).map(
            (competitiveProgramming, index) => {
                return (
                    <BigBox
                        key={"competitive-programming" + index}
    ...
    const getCompetitiveProgrammingData = () => {
        return CompetitiveProgrammingData.slice(1).map(
            (competitiveProgramming, index) => {
                return (
                    <SmallBox
                        key={"competitive-programming" + index}
