...
const BigBox = (props) => {
    const renderImage = () => {
        ...
        if (props.data.image === "Udacity") {
            ...
            imageData = {
                type: 'SVG',
                data: <svg xmlns="http://www.w3.org/2000/svg" viewBox="-1 -1 123 37" id="icon-bms-logo-new">
                    <g fill="none" fillRule="evenodd">
                        <path
                            ...
                            fill="#D61920" mask="url(#mask-2)" transform="translate(40.8)"></path>
                        <path
                        ...
                        <path
                            ...
                            fill="#333545" mask="url(#mask-4)" transform="translate(0 4.13)"></path>
                        <path
                        ...
                        <path
                            ...
                            fill="#333545" mask="url(#mask-6)" transform="translate(106.83 10.25)"></path>
                    </g>
                </svg>
            }
        }
        ...
        if (imageData) {
            if (imageData.type === "SVG") {
                ...
                return (
                    <img src={imageData.data} className="img-responsive" alt={props.data.image}/>
                )
            }
        }
    };
