...
const Sidebar = () => (
    <div className="mdl-layout__drawer">
        <nav className="mdl-navigation">
            ...
            <a className="mdl-navigation__link" href="http://bit.ly/202001ManishBishtResume" target="_blank"
               rel="noopener noreferrer">Resume</a>
            <a className="mdl-navigation__link" href="https://github.com/manishbisht" target="_blank"
               rel="noopener noreferrer">Code on Github</a>
            <a className="mdl-navigation__link" href="https://medium.com/@manishbisht" target="_blank"
               rel="noopener noreferrer">Blog on Medium</a>
